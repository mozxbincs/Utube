...
import com.example.youtube.databinding.ItemVideoHeaderBinding


class PlayerVideoAdapter(private val context: Context, private val onClick: (PlayerVideo) -> Unit) :
    androidx.recyclerview.widget.ListAdapter<PlayerVideoModel, RecyclerView.ViewHolder>(diffUtil) {
